...
(function(exports) {
  ...
  var renderObject = function (template, obj, prototypical) {
    ...
    for (var key in obj) {
      if (obj.hasOwnProperty(key) || !!prototypical) {
          ...
          if (node.nodeType === 3) {
            ...
            if (!!proxy) {
              ...
              if (!!proxy) {
                ...
                if (!!formatter && !!EXPRESSION[formatter]) {
                  node.nodeValue = EXPRESSION[formatter](proxy === TOKEN.key ? key : value);
                } else {
  ...
  var renderArray = function (template, arr, prototypical) {
        ...
        if (node.nodeType === 3) {
          ...
          if (!!proxy) {
            ...
            if (!!proxy) {
              ...
              if (!!formatter && !!EXPRESSION[formatter]) {
                node.nodeValue = EXPRESSION[formatter](value);
              } else {
  ...
  var renderCollection = function (template, collection, prototypical) {
          ...
          if (node.hasAttribute(MARKER.repeat) && node.hasAttribute(MARKER.source)) {
            ...
            if (!!deepdata) {
              if (deepdata === Object(deepdata)) {
                renderObject(node, deepdata, prototypical);
              } else if (Array.isArray(deepdata)) {
                renderCollection(node, deepdata, prototypical);
              }
            }
          } else {
            for (var j = attrs.length - 1; j >= 0; j--) {
                  ...
                  if (!!proxy) {
                    ...
                    if (!!formatter) {
                      if (formatter === "concat") {
                        ...
                        attrs[j].value = EXPRESSION[formatter](value);
                      }
                    } else {
                      attrs[j].value = value;
                    }
  ...
  exports.MicrodataTemplate = function(options) {
    ...
    api.render = function(ele, data, flag) {
      ...
      if (Array.isArray(data)) {
        if (typeof data[0] === "object") {
          renderCollection(ele, data, flag);
        } else {
          renderArray(ele, data, flag);
        }
      } else if (typeof data === "object") {
        renderObject(ele, data, flag);
      }
    };
    ...
    api.refresh = function(ele, data, flag) {
